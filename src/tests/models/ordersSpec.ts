...
describe('-----------------model: order -------------------', ()=>{
  describe('order model defined', () => {
    ...
    it('should have a close order Status method', () => {
  ...
  describe('CRUD APIs working', () => {
    ...
    it('returns list of all orders ----> index() method', async () => {
    ...
    it('updates status for order_id 1 to closed (true) ----> closeOrderStatus', async () => {
